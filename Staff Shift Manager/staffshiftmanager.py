...
class Roleplayer:
    def __init__(self):
        self.options = {
            1: {"name": "Users Banned", "points": 0},
            2: {"name": "Unbanned", "points": 0},
            3: {"name": "Kicked", "points": 0},
            4: {"name": "Warned", "points": 0},
            5: {"name": "Muted", "points": 0},
            6: {"name": "Support Given", "points": 0},
            7: {"name": "Tickets Done", "points": 0}
        }
        self.error_message = ""
    ...
    def finish_deployment(self, start_time):
        ...
        if confirm == 'y':
            ...
            with open(f"logs/stafflog_{datetime.datetime.now().strftime('%Y%m%d')}.txt", "w") as file:
...
def main():
    ...
    print("Tool created by Cactos, Version 1.1, Do not steal.")
    while True:
